$(function(){
	new  Slideshow({
		boxId:"#lun",
 		imgs:["imgs/l-1.jpg","imgs/l-2.jpg","imgs/l-3.jpg","imgs/l-4.jpg"],
		width:1920,
		height:420,
		timeSpace:2000,
		fadeInOutTime:1000,
		btnColor:"rgba(255,255,255,0.5)",
		btnHighColor:"rgba(204,51,64,1)",
		btnWidth:20,
		btnHeight:20,
		btnHasOrd:true
	});
...
Slideshow.prototype.initUI = function(){
	...
	//2、所有按钮的创建
	let ulliStr = "<ul style='position:absolute;right:700px;bottom:15px;z-index:8;display:flex;justify-content:space-between'>";
